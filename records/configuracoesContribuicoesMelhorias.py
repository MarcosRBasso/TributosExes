...
class contribMelhoriasTaxas(Conexao):
    ...
    def send_post(self, id, idCreditoCalculoMelhoria, idCreditosTributariosRec, formatoCalculoMelhoria):
        ...
        if formatoCalculoMelhoria != None:
            objeto[0]["content"]["formatoCalculoMelhoria"] = f"{formatoCalculoMelhoria}"  

        if idCreditosTributariosRec != None:
            objeto[0]["content"]["idCreditosTributariosRec"] = { "id": int(idCreditosTributariosRec)}    
               
        if idCreditoCalculoMelhoria != None:
            objeto[0]["camposadicionais"]["idCreditoCalculoMelhoria"] = { "id": int(idCreditoCalculoMelhoria)}
